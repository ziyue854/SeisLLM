...
def save_checkpoint(
    save_path: str, epoch: int, model, optimizer, scheduler, best_loss: float, scaler=None
) -> None:
    """Save checkpoint."""
    ...
    if scaler is not None:
        checkpoint_dict["scaler_dict"] = scaler.state_dict()
...
def load_checkpoint(
    ...
    if resume:
        ...
        if scaler is not None and "scaler_dict" in checkpoint:
