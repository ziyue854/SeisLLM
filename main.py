...
def get_args():
    ...
    # Model
    parser.add_argument("--model-name", default="SeisLLM_emg", type=str, metavar="MODEL_NAME",
                        help="model name: 'SeisLLM_emg/SeisLLM_dis/SeisLLM_dpk' (default: SeisLLM_emg)")
    parser.add_argument("--checkpoint", default="", type=str, metavar="CHECKPOINT",
                        help="path to latest checkpoint (default: none)")
    parser.add_argument("--use-flash-attn", type=bool_, default=True, metavar="USE_FLASH_ATTN",
                        help="if `True`, use flash attention")
    parser.add_argument('--llm', type=str, default="GPT2", help="the name of LLM") # LLAMA, GPT2, BERT
    ...
    parser.add_argument('--LLM_layer_num', type=int, default=6, help="using LLM layers number")
    parser.add_argument('--d_model', type=int, default=768, help="hideen dimension of LLM") # LLama7b:4096; GPT2-small:768; BERT-base:768
    parser.add_argument('--d_patch', type=int, default=256, help="dimension of the patch embedding")
    ...
    parser.add_argument("--dataset-name", default="diting_light", type=str, metavar="DATASET_NAME",
                        help="name of dataset ('diting_light', 'diting') (default: 'diting_light')")
